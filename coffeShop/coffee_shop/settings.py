...
SECRET_KEY = "django-insecure-u(c%rzlszxf-s&(#5)ywtphi^ri#hia=#*=dj7wcd0gc+5y*fx"
...
TEMPLATES = [
    {
        ...
        "DIRS": [
            os.path.join(
                BASE_DIR, "templates"
            ),  # para que django busque las plantillas en la carpeta 'templates' de la raiz del proyecto
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
